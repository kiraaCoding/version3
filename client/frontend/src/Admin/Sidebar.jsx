...
export default function Sidebar() {
    ...
    return (
        <div className="flex fixed flex-col max-md:ml-0 max-md:w-full z-10 top-0 left-0">
    ...
    <div className="Item flex gap-5 px-12 py-2.5 mt-6 text-lg font-semibold whitespace-nowrap bg-white text-primary max-md:px-5"        onClick={() => handleItemClick("Users")}
    ...
    <div className="Item flex gap-5 px-12 py-2.5 mt-6 text-lg font-semibold whitespace-nowrap bg-white text-primary max-md:px-5"        onClick={() => handleItemClick("Events")}
    ...
    <div className=" Item flex gap-5 px-12 py-2.5 mt-3.5 text-lg font-semibold whitespace-nowrap bg-white text-primary max-md:px-5"        onClick={() => handleItemClick("Workshops")}
        selected={selectedItem === "Workshops"}>
