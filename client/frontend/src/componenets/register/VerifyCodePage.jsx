...
export default function VerifyCodePage() {
    ...
    const [numBurEn, setNumBurEn] = useState("");
    ...
    useEffect(() => {
        ...
        setDepEn(searchParams.get('depEn'));
        setNumBurEn(searchParams.get('numBurEn'));
        setGradeEn(searchParams.get('gradeEn'));
    ...
    const handleSubmit = async (e) => {
        ...
        setError(false);
        try {
            const res = await axios.post("http://localhost:8800/checkVerificationCode", { 
                email,
                verificationCode,
                nomUt,
                emailUt,
